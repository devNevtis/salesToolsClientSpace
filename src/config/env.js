  ...
  endpoints: {
    ...
    users: {
      ...
      business2: {
        ...
        update: (id) => `${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_BUSINESS_ENDPOINT}/update/${id}`,
        delete: (id) => `${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_BUSINESS_ENDPOINT}/delete/${id}`,
        create: `${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_BUSINESS_ENDPOINT}/create`,
        getByUser: (userId) => `${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_BUSINESS_ENDPOINT}/createdBy/${userId}`
      },
      leads: {
      ...
      leads2: {
        ...
        update: (id) => `${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_LEADS_ENDPOINT}/update/${id}`,
        delete: (id) => `${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_LEADS_ENDPOINT}/delete/${id}`
      },
      config: {
